...
namespace PB_WebApi.Migrations
{
    ...
    [Migration("20230302183411_update-admin-password")]
            ...
            modelBuilder.Entity("Persistence.Entities.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ea516043-3498-4966-b4ac-fe0c6fd07455",
                            ...
                            RepositoryType = 0,
                            RoleId = "19e23249-8754-4cd5-850f-947dee37d402",
                            SessionToken = "19e23249-8754-4cd5-850f-947dee37d402"
                        });
                });
            ...
            modelBuilder.Entity("Persistence.Entities.UserRoleEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "19e23249-8754-4cd5-850f-947dee37d402",
                            RoleType = 1
                        },
                        new
                        {
                            Id = "b6fd2c21-dbe2-41c2-9090-9085f7c126f2",
                            RoleType = 0
                        });
                });
